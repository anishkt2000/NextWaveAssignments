...
export function assessRisk(transaction: AnonymizedTransaction): number {
  ...
  riskScore += currencyRisk[transaction.transactionDetails.currency as keyof typeof currencyRisk] || 10;
  ...
  riskScore += paymentMethodRisk[transaction.transactionDetails.paymentMethod as keyof typeof paymentMethodRisk] || 7;
  ...
  riskScore += categoryRisk[transaction.transactionDetails.merchantDetails.category as keyof typeof categoryRisk] || 5;
  ...
  riskScore += countryRisk[transaction.transactionDetails.merchantDetails.countryCode as keyof typeof countryRisk] || 10;
